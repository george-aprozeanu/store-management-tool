...
public class JwtTokenAuthProvider implements AuthenticationProvider {
    ...
    public JwtTokenAuthProvider(UserService userService, PasswordEncoder passwordEncoder) {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        System.out.println("jwt auth for: " + authentication);
...
//        return new AuthenticationImpl(userAndRoles.user());
    ...
    public boolean supports(Class<?> authentication) {
        System.out.println("jwt supports: " + authentication);
